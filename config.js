...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '~~ᴍʀͥ.ᴄͣʜͫᴀmuwa',
    ...
    BOT_INFO: process.env.BOT_INFO || '~~ᴍʀͥ.ᴄͣʜͫᴀmuwa;~~ᴍʀͥ.ᴄͣʜͫᴀmuwa;94740952096;https://i.imgur.com/6oRG106.jpeg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '~~ᴍʀͥ.ᴄͣʜͫᴀmuwa;~~ᴍʀͥ.ᴄͣʜͫᴀmuwa;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '~~ᴍʀͥ.ᴄͣʜͫᴀmuwa;~~ᴍʀͥ.ᴄͣʜͫᴀmuwa' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '94740952096,0',
       DEBUG: DEBUG
};
